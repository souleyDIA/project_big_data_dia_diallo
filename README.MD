...
### Données
- **Source** : L'ensemble de données "Amazon Product Review" récupéré depuis Kaggle. Il s'agit d'un ensemble historique d'avis laissés par les utilisateurs d'Amazon.
